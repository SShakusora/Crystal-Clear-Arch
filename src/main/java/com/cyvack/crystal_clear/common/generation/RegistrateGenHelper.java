...
public class RegistrateGenHelper {
    ...
    private static IDArrayHolder<ResourceLocation> getGlassScaffoldingHolder(String modId, String casing, boolean clear) {
        ...
        holder.add("main", ResourceLocation.fromNamespaceAndPath(modId, "block/scaffold/block"));
        holder.add("item_main", ResourceLocation.fromNamespaceAndPath(modId, "block/scaffold/block"));
        holder.add("casing", ResourceLocation.fromNamespaceAndPath(modId, "block/".concat(casing).concat(clear ? "_clear" : "").concat("_glass_casing")));
        ...
        if (casing.contentEquals("andesite") || casing.contentEquals("brass") || casing.contentEquals("copper")) {
            ...
            holder.add("top", ResourceLocation.fromNamespaceAndPath(modId, scaffoldingFolder + casing + "_frame"));
            holder.add("inside", ResourceLocation.fromNamespaceAndPath(modId, scaffoldingFolder + casing + "_scaffold_inside"));
            holder.add("side", ResourceLocation.fromNamespaceAndPath(modId, scaffoldingFolder + casing + "_scaffold"));
            holder.add("particle", ResourceLocation.fromNamespaceAndPath(modId, scaffoldingFolder + casing + "_scaffold"));
        }
    ...
    public static ResourceLocation getBacking(String modid, String casing) {
        ...
        if (casing.equals("andesite"))
            texture = ResourceLocation.withDefaultNamespace("block/stripped_spruce_log_top");
        else if (casing.equals("brass"))
            texture = ResourceLocation.withDefaultNamespace("block/stripped_dark_oak_log_top");
        else
            texture = ResourceLocation.fromNamespaceAndPath(modid, "block/" + casing + "_backing");
    ...
    public static ResourceLocation getSiding(String modid, String casing, boolean large) {
        ...
        texture = ResourceLocation.fromNamespaceAndPath(modid, "block/encased_cogwheels/" + (large ? "large_" : "") + casing + "_encased_cogwheel_side");
    ...
    public static ResourceLocation getOpening(String modid, String casing) {
        ...
        if (casing.equals("andesite"))
            ...
            texture = ResourceLocation.fromNamespaceAndPath(modid, "block/" + casing + "_gearbox");
